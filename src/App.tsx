...
const styles = StyleSheet.create({screen: {flex: 1, backgroundColor: '#080e16'}, chrome: {flex: 1, paddingHorizontal: '5%', paddingVertical: 16}, reviewScreen: {flex: 1, alignItems: 'center', justifyContent: 'center', gap: 14}, selectorHint: {fontSize: 20, color: '#c7d6e7', marginBottom: 8}, top: {flexDirection: 'row', justifyContent: 'space-between'}, brand: {fontSize: 24, color: '#f3dfb7', letterSpacing: 4}, demo: {fontSize: 18, color: '#ccd3dd', backgroundColor: '#101720df', padding: 7}, debugArea: {alignSelf: 'flex-start', marginTop: 8}, reviewSelector: {flexDirection: 'row', gap: 8, alignItems: 'center'}, debugCue: {paddingHorizontal: 10, paddingVertical: 3, color: '#c7d6e7', backgroundColor: '#101720df', fontSize: 16}, fullMovementBody: {flex: 1, minHeight: 0, marginTop: 6}, guidedBase: {flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#101720df', borderRadius: 8}, baseWork: {fontSize: 25, color: '#e5dfd3', letterSpacing: 2}, baseMovement: {fontSize: 21, color: '#b8c1ca', marginTop: 8}, baseHeading: {fontSize: 32, color: '#f1cd87', fontWeight: '700', letterSpacing: 3, marginTop: 28}, baseHint: {fontSize: 22, color: '#d6e2ef', marginTop: 10}, bottom: {width: '100%'}, progress: {height: 4, backgroundColor: '#535c69', marginTop: 8, marginBottom: 8}, fill: {height: 4, backgroundColor: '#f1cd87'}, transport: {flexDirection: 'row', alignItems: 'center', flexWrap: 'nowrap'}, time: {fontSize: 20, color: '#e0e5ec', marginLeft: 10}, error: {padding: 18, backgroundColor: '#351c21'}, message: {fontSize: 28, color: '#fff'}, detail: {fontSize: 20, color: '#f4c6c6', marginTop: 8}});
