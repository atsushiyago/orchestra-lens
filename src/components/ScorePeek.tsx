...
export function ScorePeek({event, onClose}: {event?: ScoreEvent; onClose: () => void}) {
  ...
  return <View style={styles.screen} accessibilityViewIsModal>
      ...
      {comparisonOpen && themeLens && firstHeardAsset ? <View style={styles.comparison}>
